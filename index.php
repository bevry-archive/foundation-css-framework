 ...
 */
$system = '/Users/anthonyshort/Dropbox/Projects/Scaffold/Source/';

/**
 * Default Source File
 *
 * If no source file is given, it will parse this file if it can be found
 */
$config['default_source'] = 'src/master.css';

/**
 * Cache Directory
 */
$config['cache_dir'] = './build/';
$config['cache_as_filename'] = true;
